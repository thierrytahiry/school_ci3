    ...
    <div class="wrapper">
        ...
        <aside class="main-sidebar sidebar-dark-primary elevation-4">
            ...
            <a href="index3.html" class="brand-link navbar-blue">
                <img src="<?php echo base_url() ?>tools/dist/img/AdminLTELogo.png" alt="AdminLTE Logo" class="brand-image img-circle elevation-3" style="opacity: .8">
                <span class="brand-text font-weight-light">E.M.I.T</span>
            </a>
                    ...
                    <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
                        ...
                        <li class="nav-item menu-close">
                            ...
                            <ul class="nav nav-treeview">
                                <li class="nav-item">
                                    <a href="<?php echo base_url() . 'index.php/ecole/categorie' ?>" class="nav-link">
                        ...
                        <li class="nav-item menu-close">
                            ...
                            <ul class="nav nav-treeview">
                                <li class="nav-item">
                                    <a href="<?php echo base_url() . 'index.php/ecole/classes' ?>" class="nav-link">
                                        <i class="far fa-circle nav-icon"></i>
                                        <p>Classes</p>
                                    </a>
                                </li>
                        ...
                        <li class="nav-item menu-close">
                            ...
                            <ul class="nav nav-treeview">
                                <li class="nav-item">
                                    <a href="<?php echo base_url() . 'index.php/ecole/course' ?>" class="nav-link">
                                        <i class="far fa-circle nav-icon"></i>
                                        <p>Course</p>
                                    </a>
                                </li>
                        ...
                        <li class="nav-item menu-close">
                            <a href="#" class="nav-link">
                                <i class="nav-icon fas fa-tachometer-alt"></i>
                                <p>
                                    Etudiants Management
                                    <i class="right fas fa-angle-left"></i>
                                </p>
                            </a>
                            <ul class="nav nav-treeview">
                                <li class="nav-item">
                                    <a href="<?php echo base_url() . 'index.php/etudiant/etudiant' ?>" class="nav-link">
                                        <i class="far fa-circle nav-icon"></i>
                                        <p>Etudiants Registration</p>
                                    </a>
                                </li>
                            </ul>
                        </li>
                        <li class="nav-item menu-close">
                            ...
                            <ul class="nav nav-treeview">
                                <li class="nav-item">
                                    <a href="<?php echo base_url() . 'index.php/staff/staff' ?>" class="nav-link">
                                        <i class="far fa-circle nav-icon"></i>
                                        <p>Staff</p>
                                    </a>
                                </li>
                        ...
                        <li class="nav-item menu-close">
                            ...
                            <ul class="nav nav-treeview">
                                <li class="nav-item">
                                    <a href="<?php echo base_url() . 'index.php/attandance/' ?>" class="nav-link">
                                        <i class="far fa-circle nav-icon"></i>
                                        <p>Attandance</p>
                                    </a>
                                </li>
                        ...
                        <li class="nav-item menu-close">
                            ...
                            <ul class="nav nav-treeview">
                                <li class="nav-item">
                                    <a href="<?php echo base_url() . 'index.php/examen/add_examen' ?>" class="nav-link">
                                        <i class="far fa-circle nav-icon"></i>
                                        <p>Examen</p>
                                    </a>
                                </li>
                                <li class="nav-item">
                                    <a href="<?php echo base_url() . 'index.php/examen/add_time_table' ?>" class="nav-link">
                                        <i class="far fa-circle nav-icon"></i>
                                        <p>Add Time Table</p>
                                    </a>
                                </li>
                        ...
                        <li class="nav-item menu-close">
                            ...
                            <ul class="nav nav-treeview">
                                <li class="nav-item">
                                    <a href="<?php echo base_url() . 'index.php/resultat' ?>" class="nav-link">
                                        <i class="far fa-circle nav-icon"></i>
                                        <p>Resultat</p>
                                    </a>
                                </li>
